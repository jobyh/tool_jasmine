...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="http://vagrant.localhost/admin/tool/jasmine/lib/jasmine-2.4.1/jasmine_favicon.png">
    <link rel="stylesheet" href="http://vagrant.localhost/admin/tool/jasmine/lib/jasmine-2.4.1/jasmine.css">

    <script src="http://vagrant.localhost/admin/tool/jasmine/lib/jasmine-2.4.1/jasmine.js"></script>
    <script src="http://vagrant.localhost/admin/tool/jasmine/lib/jasmine-2.4.1/jasmine-html.js"></script>

    <script src="http://vagrant.localhost/admin/tool/jasmine/lib/jasmine-2.4.1/boot.js"></script>
